    ...
    <el-main class="main">
      <el-tabs v-model="activeName" @tab-click="handleClick" type="card">
        ...
        <el-tab-pane label="草稿箱" name="draft">
          <blog_table state="1" :showEdit="true" :showDelete="true" :showRestore="false"></blog_table>
        </el-tab-pane>
        <el-tab-pane label="回收站" name="dustbin">
          <blog_table state="-1" :showEdit="false" :showDelete="true" :showRestore="true"></blog_table>
        </el-tab-pane>
        <el-tab-pane label="博客管理" name="blogmana" v-if="isAdmin">
          <blog_table state="-2" :showEdit="false" :showDelete="true" :showRestore="false"></blog_table>
        </el-tab-pane>
